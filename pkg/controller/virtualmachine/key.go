...
import (
	...
	secret2 "github.com/negashev/hf-provisioner-digitalenergy/pkg/controller/virtualmachine/secret"
...
func KeyHandler(req router.Request, resp router.Response) error {
	secret, err := secret2.GetSecret(req)
	if err != nil {
		return err
	}
	...
	name := fmt.Sprintf("%s-basis-key", req.Object.GetName())
	key.Name = name
